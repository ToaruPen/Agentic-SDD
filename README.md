...
./scripts/agentic-sdd/shell/worktree.sh new --issue 123 --desc "add user profile" --tool opencode
./scripts/agentic-sdd/shell/worktree.sh new --issue 124 --desc "add settings page" --tool opencode
```
...
# Preview (no changes)
./scripts/agentic-sdd/shell/sync-agent-config.sh --dry-run
```
...
- Enable: `./scripts/agentic-sdd/shell/setup-githooks.sh` (the installer attempts to configure this automatically)
- Claude Code: `.claude/settings.json` (PreToolUse hooks: Edit/Write + git commit/push)
- OpenCode: `.opencode/plugins/agentic-sdd-gate.js` (generated by `./scripts/agentic-sdd/shell/sync-agent-config.sh opencode`)

Gate scripts:

- `scripts/agentic-sdd/gates/validate_worktree.py` (or wrapper: `scripts/agentic-sdd/validate-worktree.py`)
- `scripts/agentic-sdd/gates/validate_approval.py` (or wrapper: `scripts/agentic-sdd/validate-approval.py`)
