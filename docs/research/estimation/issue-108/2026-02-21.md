...
- /Users/sankenbisha/Dev/.worktrees/Agentic-SDD/issue-108-pr-bots-review-rename/scripts/sync-agent-config.sh
捨て条件:
...
候補-2
概要: レビュー再依頼メンションを単一環境変数（例: `AGENTIC_SDD_REVIEW_MENTION`）へ統一する
適用可否: Yes
...
根拠リンク:
- https://github.com/ToaruPen/Agentic-SDD/issues/108
- /Users/sankenbisha/Dev/.worktrees/Agentic-SDD/issue-108-pr-bots-review-rename/templates/ci/github-actions/scripts/agentic-sdd-pr-autofix.sh
- /Users/sankenbisha/Dev/.worktrees/Agentic-SDD/issue-108-pr-bots-review-rename/scripts/tests/test-pr-autofix-template.sh
捨て条件:
...
根拠リンク:
- https://github.com/ToaruPen/Agentic-SDD/issues/108
- /Users/sankenbisha/Dev/.worktrees/Agentic-SDD/issue-108-pr-bots-review-rename/scripts/codex-review-event.sh
- /Users/sankenbisha/Dev/.worktrees/Agentic-SDD/issue-108-pr-bots-review-rename/scripts/watch-codex-review.sh
- /Users/sankenbisha/Dev/.worktrees/Agentic-SDD/issue-108-pr-bots-review-rename/templates/ci/github-actions/scripts/agentic-sdd-pr-autofix.sh
捨て条件:
...
根拠リンク:
- https://github.com/ToaruPen/Agentic-SDD/issues/108
- /Users/sankenbisha/Dev/.worktrees/Agentic-SDD/issue-108-pr-bots-review-rename/README.md
- /Users/sankenbisha/Dev/.worktrees/Agentic-SDD/issue-108-pr-bots-review-rename/AGENTS.md
捨て条件:
...
- https://github.com/ToaruPen/Agentic-SDD/issues/108
- /Users/sankenbisha/Dev/.worktrees/Agentic-SDD/issue-108-pr-bots-review-rename/scripts/tests/test-pr-autofix-template.sh
- /Users/sankenbisha/Dev/.worktrees/Agentic-SDD/issue-108-pr-bots-review-rename/scripts/worktree.sh
捨て条件:
...
- 未解決: レビュー再依頼メンション変数名の最終命名（`AGENTIC_SDD_REVIEW_MENTION` など）と既定値ポリシー
